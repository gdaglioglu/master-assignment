...
public class ConfigOptions extends JPanel {
	...
	private static final String DB_HD_LOCATION_TOOL_TIP = "The location of the database on an accessible hard drive";
	private static final String DB_IP_LOCATION_TOOL_TIP = "The server where the database is located (IP address)";
	private static final String SERVER_PORT_TOOL_TIP = "The port number the Server uses to listens for requests";

	private static final String DATABASE_EXTENSION = "dvd";
	private static final String DATABASE_FILE_CHOOSER_DESCRIPTION = "Database files (*."
			+ DATABASE_EXTENSION + ")";
	...
	private JLabel rmiOption = new JLabel(RMI_SERVER_TEXT);
	 ...
	 *            one of <code>STANDALONE_CLIENT_MODE</code>,
	 ...
	 *
	 * @param updateType
	 *            Enum specify which field has changed
	 * @param payLoad
	 *            the new data the user just entered.
	 */
	...
	/**
	 * A utility class to handle user interactions with the panel. These are not
	 * processed by the user of this panel, rather they are processed
	...
	private class BrowseForDatabase implements ActionListener {
		...
		public void actionPerformed(ActionEvent ae) {
			...
			chooser.addChoosableFileFilter(new javax.swing.filechooser.FileFilter() {
				/**
				 * display files ending in ".db" or any other object (directory
				 * or other selectable device).
				 */
				@Override
				...
				/**
				 * provide a description for the types of files we are allowing
				 * to be selected.
				 */
				@Override
	...
	/**
	 * Returns the mode the application will be running in (networked,
	 * standalone, etc).
	 * 
	 * @return the mode the application will be running in (networked,
	 *         standalone, etc).
	 * @see ApplicationMode
	 */
	 ...
	 *
	 * @param locationField
	 *            the contents of the database location field.
	 */
	 ...
	 *
	 * @param enabled
	 *            true if the location field is enabled.
	 */
	 ...
	 *
	 * @param enabled
	 *            true if the browse button is enabled.
	 */
	 ...
	 *
	 * @param portNumber
	 *            the contents of the port number text field.
	 */
	 ...
	 *
	 * @param enabled
	 *            true if the port number field is enabled.
	 */
	...
	/**
	 * Our Observabe class - a class that Observers can register themselves with
	 * in order to recieve updates as things change within this panel.
	 */
	 ...
	 * register themselves with this class in order to recieve updates as things
	 * change within this panel.
	 *
